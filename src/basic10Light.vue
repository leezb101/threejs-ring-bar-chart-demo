...
import { AmbientLight, AxesHelper, BoxGeometry, Clock, Color, Mesh, MeshLambertMaterial, PerspectiveCamera, PlaneGeometry, Scene, SpotLight, Vector2, WebGLRenderer } from 'three'
...
function init() {
  ...
  // const ablight = new AmbientLight(new Color(0x606008))
  // scene.add(ablight)
  const spotLight = new SpotLight(0xffffff)
  spotLight.position.set(-40, 40, -15)
  spotLight.castShadow = true
